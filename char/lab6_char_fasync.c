...
int chardrv_fasync(int fd, struct file *filp, int mode);
...
int chardrv_fasync(int fd, struct file *filp, int mode)
{
	pr_info("LDDChar: fasync invoked ...\n");
...
static int __init chardrv_init(void)
{
   ...
   pr_info("LDDChar: Device class registered successfully\n");
...
MODULE_DESCRIPTION("LDDChar: Character driver to demostrate fasync operation");
